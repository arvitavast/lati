...
<head>
  ...
  <title>Läti projekti statistika</title>
<style>
...
<section class='container'>
          <hgroup>
            <h1>Läti projekti statistika</h1>
          </hgroup>

        <div class="row">
          <section class='col-xs-12 col-sm-6 col-md-6'>
            <section>
              <h2>Sõnade arv praegu</h2>
                ''' + no + '''
          ...
          <section class='col-xs-12 col-sm-6 col-md-6'>
            <section>
              <h2>Küljendus</h2>
                <a href="https://www.dropbox.com/s/jw11twcx9rqarh2/kogu_sonastik.pdf?dl=0">Kogu sõnastik</a>
